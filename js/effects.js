class Effects {
  constructor(board) {
    this.board = board;
    this.frame = document.getElementById('boardFrame') || document.getElementById('board3d');
    ...
    this.toastIcons = { lose: '⏳', death: '💀', start: '🏰', win: '🏆', info: '✨' };
    this.startAmbient();
  ...
  screenShake() {
    const frame = document.getElementById('boardFrame') || document.getElementById('board3d');
    if (!frame) return;
